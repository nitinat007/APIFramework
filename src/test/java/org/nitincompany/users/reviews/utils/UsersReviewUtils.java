...
import org.nitincompany.users.reviews.utils.comparators.ReviewComparator;

import java.io.*;
import java.util.*;

import static org.nitincompany.users.reviews.utils.filters.UserReviewFilters.*;
...
//        System.out.println("\n ************* \n Applying contentTypes filters: " + contentTypes);
        reviewsArrayFromCSV = applyContentTypesFilter(reviewsArrayFromCSV, contentTypes);
...
//        System.out.println("\n ************* \n Applying context filters: " + context);
        reviewsArrayFromCSV = applyContextFilter(reviewsArrayFromCSV, context);
//
...
//        System.out.println("\n ************* \n Applying sorting : sortBy=" + sortBy + " sortOrder=" + sortOrder);
        reviewsArrayFromCSV = applySortingFilter(reviewsArrayFromCSV, sortBy, sortOrder);
//
...
//        System.out.println("\n ************* \n Applying reviewStatusFilter : reviewStatusSet=" + reviewStatusSet );
        reviewsArrayFromCSV = applyReviewStatusFilter(reviewsArrayFromCSV, reviewStatusSet);
...
//        System.out.println("\n ************* \n Applying createdTimestampLimits ");
        reviewsArrayFromCSV = applyTimeStampLimitFilter(reviewsArrayFromCSV, createdTimestampLimits);
...
//        System.out.println("\n ************* \n Applying applySkip_LimitFilter : skip=" + skip + " limit=" + limit);
        reviewsArrayFromCSV = applySkip_LimitFilter(reviewsArrayFromCSV, skip, limit);
//
